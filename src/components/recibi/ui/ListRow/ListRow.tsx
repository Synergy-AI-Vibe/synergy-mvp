  ...
  return (
    <li className="flex items-center gap-2 border-b border-line">
      ...
      {onDelete && (
        ...
        <button
          type="button"
          className="relative inline-flex size-[30px] flex-none items-center justify-center text-[15px] text-text-2 before:absolute before:-inset-[7px] before:content-[''] hover:text-accent"
          onClick={onDelete}
          aria-label={`${title} 삭제`}
        >
          ×
